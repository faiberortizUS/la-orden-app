...
function renderOath(data) {
  ...
  return `
    <div class="view" id="view-oath">
      ...
      <div class="card card--glass flex tappable" style="align-items:center;gap:16px;border-color:rgba(123,97,255,0.3);margin-bottom:var(--s4);" onclick="showGuideDailyMessage()">
        ...
        <div style="flex:1;">
          ...
          <div class="text-sm text-muted" style="line-height:1.4;">"Toca aquí para leer tu mensaje de élite de hoy..."</div>
        </div>
